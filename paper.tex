...
The proof concept of the proposed trace analysis method is demonstrated on a transaction level model of a SoC design from GEM5 with two ARM CPU cores, and one memory connected by an interconnect as shown in Fig 1. Since the analysis method presented in this paper is communication centric, the detailed computations of these blocks are not modeled. Instead, the modeling is focused on how they participate in flows for different system level use cases. 
...
\begin{figure} 
\centerline{
\includegraphics[width=4in]{figures/Fig.png}}
